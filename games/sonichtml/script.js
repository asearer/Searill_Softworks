alert("You are about to play SONIC HTML Developed by Searill Softworks. Make sure to adjust your browser zoom for a better experience; you can try it at 80%.")
...
let death = document.querySelector('.die');
...
var x=0; //Counter to track Sonic's horizontal position
var y=0; //Counter to track Sonic's vertical position
...
window.addEventListener('load', () => {
    ...
    death.style.position = 'relative';
    death.style.top="-2768px";
    death.style.left = "220px"
